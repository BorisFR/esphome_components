...
void JD9365::draw_pixel_at(int x, int y, Color color) {
  ...
  //this->draw_pixels_at(x, y, 1, 1, (const uint8_t *) &pixel, display::COLOR_ORDER_RGB, display::COLOR_BITNESS_565, false, 0, 0, 0);

  this->draw_pixels_at(x, y, 1, 1, (const uint8_t *) &color, display::COLOR_ORDER_RGB, display::COLOR_BITNESS_888, true, 0, 0, 0);
